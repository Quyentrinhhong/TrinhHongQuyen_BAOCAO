      ...
      <section class="content">
         <div class="card">
            <div class="card-header">
               <div class="row">
                  <div class="col-md-6">
                     <a href="index.php?option=page&cat=trash" class="btn btn-sm btn-dark"> Thùng rác</a>
                  </div>
                  <div class="col-md-6 text-right">
                     <a href="index.php?option=page&cat=page-create" class="btn btn-sm btn-dark">Thêm trang đơn</a>
                  </div>
               </div>
            </div>

            ...
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-12">
                     ...
                     <a href="index.php?option=customer&cat=customer-create" class="btn btn-sm btn-dark">Thêm khách hàng</a>
                  </div>
               </div>
            </div>
         </section>
         ...
         <section class="content">
            <div class="card">
               ...
               <div div class="col-md-6">
                     <a href="index.php?option=customer" class="btn btn-sm btn-dark">Tất cả</a>
                     <a href="index.php?option=customer&cat=trash" class="btn btn-sm btn-dark"><i class="fas fa-trash"></i> Thùng rác</a>
                  </div>
               </div>
               <div class="card-body">

            ...
            <div class="card">
                <div class="row">
                    <div div class="col-md-6">
                        <a href="index.php?option=menu" class="btn btn-sm btn-dark">Tất cả</a>
                        <a href="index.php?option=menu&cat=trash" class="btn btn-sm btn-dark"><i class="fas fa-trash"></i> Thùng rác</a>
                    </div>

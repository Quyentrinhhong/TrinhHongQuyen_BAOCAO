         ...
         <div class="container-fluid">
            <div class="row mb-2">
               <div class="col-sm-12">
                  ...
                  <a href="index.php?option=post&cat=post-create" class="btn btn-sm btn-dark">Thêm bài viết</a>
               </div>
            </div>
         </div>
      </section>
         ...
         <div class="card">
            <div class="card-header p-2">
               <div class="text-center">
                  <a href="index.php?option=post" class="btn btn-sm btn-dark">Tất cả</a>
                  <a href="index.php?option=post&cat=trash" class="btn btn-sm btn-dark"><i class="fas fa-trash"></i> Thùng rác</a>
               </div>
            </div>

      ...
      <section class="content">
         <div class="card">
            <div class="card-header ">
               <div class="row">
                  <div class="col-md-6">
                     <a href="index.php?option=topic" class="btn btn-sm btn-dark">Tất cả</a>
                     <a href="index.php?option=topic&cat=trash" class="btn btn-sm btn-dark"> Thùng rác</a>
                  </div>
                  <div class="col-md-6 text-right">
                     <a href="index.php?option=topic&cat=topic-create" class="btn btn-sm btn-dark">Thêm chủ đề</a>
                  </div>
               </div>
            </div>
            <div class="card-body">

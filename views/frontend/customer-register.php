...
if (isset($_POST['REGISTER'])) {
   ...
   if ($_POST['password'] === $_POST['password_re']) {
      if ($user->save()) {
         ...
         <strong>Đăng ký thành công!</strong> Cùnng TheZhin mua sắm nào ! <a href="index.php?option=customer&login=true" class="alert-link">Đăng nhập</a>.
      </div>';
         $check = true;
      ...
      Xác nhận mật khẩu không khớp — Vui lòng nhập lại thông tin !
      </div>
       ';
   }
}
                        ...
                        <div class="row">
                           <div class="col-4">
                              <select name="tinhtp" id="tinhtp" class="form-control">
                                 ...
                                 <?php
                                 $danhsachtp = [
                                    "Hà Nội", "Hồ Chí Minh", "An Giang", "Bà Rịa - Vũng Tàu", "Bạc Liêu", "Bắc Giang",
                                    "Bắc Kạn", "Bắc Ninh", "Bến Tre", "Bình Dương", "Bình Định", "Bình Phước",
                                    "Bình Thuận", "Cao Bằng", "Cà Mau", "Cần Thơ", "Hải Phòng", "Đà Nẵng",
                                    "Gia Lai", "Hòa Bình", "Hà Giang", "Hà Nam", "Hà Tĩnh", "Hưng Yên",
                                    "Hải Dương", "Hậu Giang", "Điện Biên", "Đắk Lắk", "Đắk Nông", "Đồng Nai",
                                    "Đồng Tháp", "Khánh Hòa", "Kiên Giang", "Kon Tum", "Lai Châu", "Long An",
                                 ];
                           ...
                           <div class="col-4">
                              <select name="quanhuyen" id="quanhuyen" class="form-control">
                                 ...
                                 <?php
                                 $dshuanhuyen = [
                                    "Thành phố Thủ Đức", "Quận 1", "Quận 3", "Quận 4", "Quận 5", "Quận 6", "Quận 7", "Quận 8", "Quận 10",
                                    "Quận 11", "Quận 12", "Quận Bình Tân", "Quận Bình Thạnh", "Quận Phú Nhuận", "Quận Tân Bình",
